...
const minimumDatesSummary = 18 * 5;
const amountOfDaysToFill = minimumDatesSummary - datesFromYearStart.length;
			...
			<View className="flex-1 bg-background px-8 pt-16">
				...
				>
					<View className="flex-row flex-wrap">
						{datesFromYearStart.map((date, index) => <HabitDay key={date.toISOString()} />)}
						{
